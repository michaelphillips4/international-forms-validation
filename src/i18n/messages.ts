...
export const messages = {
  [LOCALES.ENGLISH]: {
    heading: "forms validation and internationalization",
    ...
    bookAnAppointment_selectShopLabel:"Please select the shop you would you like to visit",
    ...
    bookAnAppointment_namePlaceHolder:"Mr A Smith",
    bookAnAppointment_emailPlaceHolder:"a.smith@google.com",
    ...
    appointmentBooked:"Thank you your Appointment is booked.",
  ...
  [LOCALES.ITALIAN]: {
    ...
    appointmentBooked:"Grazie il tuo appuntamento è prenotato.",
